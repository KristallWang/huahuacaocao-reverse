...
.field private static y:Landroidx/browser/browseractions/BrowserActionsIntent$a;
...
.method private static d(Landroid/content/Context;Landroid/net/Uri;ILjava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    new-instance p2, Lb/a/a/d;

    invoke-direct {p2, p0, p1, p3}, Lb/a/a/d;-><init>(Landroid/content/Context;Landroid/net/Uri;Ljava/util/List;)V

    .line 2
    invoke-virtual {p2}, Lb/a/a/d;->displayMenu()V
    ...
    .line 4
    invoke-interface {p0}, Landroidx/browser/browseractions/BrowserActionsIntent$a;->onDialogShown()V

    :cond_0
    return-void
.end method

.method public static e(Landroidx/browser/browseractions/BrowserActionsIntent$a;)V
    .locals 0
    .annotation build Landroid/support/annotation/RestrictTo;
        value = {
            .enum Landroid/support/annotation/RestrictTo$Scope;->LIBRARY_GROUP:Landroid/support/annotation/RestrictTo$Scope;
...
.method public static openBrowserAction(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    invoke-virtual {v0}, Landroidx/browser/browseractions/BrowserActionsIntent$b;->build()Landroidx/browser/browseractions/BrowserActionsIntent;
...
.method public static openBrowserAction(Landroid/content/Context;Landroid/net/Uri;ILjava/util/ArrayList;Landroid/app/PendingIntent;)V
    ...
    .line 4
    invoke-virtual {v0, p2}, Landroidx/browser/browseractions/BrowserActionsIntent$b;->setUrlType(I)Landroidx/browser/browseractions/BrowserActionsIntent$b;

    move-result-object p1

    .line 5
    invoke-virtual {p1, p3}, Landroidx/browser/browseractions/BrowserActionsIntent$b;->setCustomItems(Ljava/util/ArrayList;)Landroidx/browser/browseractions/BrowserActionsIntent$b;

    move-result-object p1

    .line 6
    invoke-virtual {p1, p4}, Landroidx/browser/browseractions/BrowserActionsIntent$b;->setOnItemSelectedAction(Landroid/app/PendingIntent;)Landroidx/browser/browseractions/BrowserActionsIntent$b;

    move-result-object p1

    .line 7
    invoke-virtual {p1}, Landroidx/browser/browseractions/BrowserActionsIntent$b;->build()Landroidx/browser/browseractions/BrowserActionsIntent;
...
.method public static parseBrowserActionItems(Ljava/util/ArrayList;)Ljava/util/List;
    ...
    invoke-direct {v5, v3, v4, v2}, Lb/a/a/a;-><init>(Ljava/lang/String;Landroid/app/PendingIntent;I)V
