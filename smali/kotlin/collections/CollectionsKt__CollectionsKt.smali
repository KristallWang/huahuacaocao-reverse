...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, Lg/i1/x;-><init>()V
...
.method public static final varargs arrayListOf([Ljava/lang/Object;)Ljava/util/ArrayList;
    ...
    new-instance v1, Lg/i1/j;

    const/4 v2, 0x1

    invoke-direct {v1, p0, v2}, Lg/i1/j;-><init>([Ljava/lang/Object;Z)V
...
.method public static final asCollection([Ljava/lang/Object;)Ljava/util/Collection;
    ...
    .line 1
    new-instance v0, Lg/i1/j;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lg/i1/j;-><init>([Ljava/lang/Object;Z)V

    return-object v0
.end method

.method public static final binarySearch(Ljava/util/List;IILg/r1/b/l;)I
    .locals 2
    ...
    .line 9
    invoke-interface {p3, v1}, Lg/r1/b/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final binarySearch(Ljava/util/List;Ljava/lang/Comparable;II)I
    ...
    .line 3
    invoke-static {v1, p1}, Lg/j1/b;->compareValues(Ljava/lang/Comparable;Ljava/lang/Comparable;)I
...
.method public static synthetic binarySearch$default(Ljava/util/List;IILg/r1/b/l;ILjava/lang/Object;)I
    .locals 0
    ...
    :cond_1
    invoke-static {p0, p1, p2, p3}, Lkotlin/collections/CollectionsKt__CollectionsKt;->binarySearch(Ljava/util/List;IILg/r1/b/l;)I
...
.method public static final binarySearchBy(Ljava/util/List;Ljava/lang/Comparable;IILg/r1/b/l;)I
    .locals 1
    .param p0    # Ljava/util/List;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-static {p4, v0}, Lg/r1/c/f0;->checkNotNullParameter(Ljava/lang/Object;Ljava/lang/String;)V

    .line 1
    new-instance v0, Lkotlin/collections/CollectionsKt__CollectionsKt$binarySearchBy$1;

    invoke-direct {v0, p4, p1}, Lkotlin/collections/CollectionsKt__CollectionsKt$binarySearchBy$1;-><init>(Lg/r1/b/l;Ljava/lang/Comparable;)V

    invoke-static {p0, p2, p3, v0}, Lkotlin/collections/CollectionsKt__CollectionsKt;->binarySearch(Ljava/util/List;IILg/r1/b/l;)I
...
.method public static synthetic binarySearchBy$default(Ljava/util/List;Ljava/lang/Comparable;IILg/r1/b/l;ILjava/lang/Object;)I
    .locals 0
    ...
    invoke-direct {p5, p4, p1}, Lkotlin/collections/CollectionsKt__CollectionsKt$binarySearchBy$1;-><init>(Lg/r1/b/l;Ljava/lang/Comparable;)V

    invoke-static {p0, p2, p3, p5}, Lkotlin/collections/CollectionsKt__CollectionsKt;->binarySearch(Ljava/util/List;IILg/r1/b/l;)I
...
.method public static final getIndices(Ljava/util/Collection;)Lg/v1/k;
    .locals 2
    ...
    invoke-direct {v0, v1, p0}, Lg/v1/k;-><init>(II)V
...
.method private static final h(ILg/r1/b/l;)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method private static final i(ILg/r1/b/l;)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method private static final j()Ljava/util/ArrayList;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method private static final k(ILg/r1/b/l;)Ljava/util/List;
    .locals 1
    .param p1    # Lg/r1/b/l;
    ...
    .line 1
    invoke-static {p0}, Lg/i1/x;->createListBuilder(I)Ljava/util/List;

    move-result-object p0

    invoke-interface {p1, p0}, Lg/r1/b/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {p0}, Lg/i1/x;->build(Ljava/util/List;)Ljava/util/List;
...
.method private static final l(Lg/r1/b/l;)Ljava/util/List;
    .locals 1
    .param p0    # Lg/r1/b/l;
        .annotation build Lkotlin/BuilderInference;
        .end annotation
    ...
    .line 1
    invoke-static {}, Lg/i1/x;->createListBuilder()Ljava/util/List;

    move-result-object v0

    invoke-interface {p0, v0}, Lg/r1/b/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {v0}, Lg/i1/x;->build(Ljava/util/List;)Ljava/util/List;
...
.method public static final listOfNotNull(Ljava/lang/Object;)Ljava/util/List;
    ...
    .line 1
    invoke-static {p0}, Lg/i1/x;->listOf(Ljava/lang/Object;)Ljava/util/List;
...
.method public static final varargs listOfNotNull([Ljava/lang/Object;)Ljava/util/List;
    ...
    .line 2
    invoke-static {p0}, Lg/i1/p;->filterNotNull([Ljava/lang/Object;)Ljava/util/List;
...
.method private static final m(Ljava/util/Collection;Ljava/util/Collection;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method private static final n(Ljava/util/Collection;Lg/r1/b/a;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<C::",
...
.method private static final p(Ljava/util/Collection;)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static final shuffled(Ljava/lang/Iterable;Lkotlin/random/Random;)Ljava/util/List;
    ...
    .line 1
    invoke-static {p0}, Lg/i1/f0;->toMutableList(Ljava/lang/Iterable;)Ljava/util/List;

    move-result-object p0

    invoke-static {p0, p1}, Lg/i1/f0;->shuffle(Ljava/util/List;Lkotlin/random/Random;)V
