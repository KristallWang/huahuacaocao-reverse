...
.field private mObservers:La/a/a/c/b;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "La/a/a/c/b<",
            "La/a/b/l<",
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/LiveData;->mObservers:La/a/a/c/b;
...
.method private static assertMainThread(Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, La/a/a/b/a;->isMainThread()Z
...
.method private considerNotify(Landroid/arch/lifecycle/LiveData$c;)V
    ...
    .line 2
    :cond_0
    invoke-virtual {p1}, Landroid/arch/lifecycle/LiveData$c;->d()Z
    ...
    .line 6
    iget-object p1, p1, Landroid/arch/lifecycle/LiveData$c;->a:La/a/b/l;

    iget-object v0, p0, Landroid/arch/lifecycle/LiveData;->mData:Ljava/lang/Object;

    invoke-interface {p1, v0}, La/a/b/l;->onChanged(Ljava/lang/Object;)V
...
.method private dispatchingValue(Landroid/arch/lifecycle/LiveData$c;)V
    ...
    .line 6
    :cond_2
    iget-object v1, p0, Landroid/arch/lifecycle/LiveData;->mObservers:La/a/a/c/b;

    .line 7
    invoke-virtual {v1}, La/a/a/c/b;->iteratorWithAdditions()La/a/a/c/b$e;
...
.method public hasObservers()Z
    ...
    .line 1
    iget-object v0, p0, Landroid/arch/lifecycle/LiveData;->mObservers:La/a/a/c/b;
...
.method public observe(La/a/b/e;La/a/b/l;)V
    .locals 2
    .param p1    # La/a/b/e;
    ...
    invoke-direct {v0, p0, p1, p2}, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;-><init>(Landroid/arch/lifecycle/LiveData;La/a/b/e;La/a/b/l;)V

    .line 3
    iget-object v1, p0, Landroid/arch/lifecycle/LiveData;->mObservers:La/a/a/c/b;

    invoke-virtual {v1, p2, v0}, La/a/a/c/b;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 4
    invoke-virtual {p2, p1}, Landroid/arch/lifecycle/LiveData$c;->c(La/a/b/e;)Z
    ...
    invoke-virtual {p1, v0}, Landroid/arch/lifecycle/Lifecycle;->addObserver(La/a/b/d;)V

    return-void
.end method

.method public observeForever(La/a/b/l;)V
    .locals 2
    .param p1    # La/a/b/l;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {v0, p0, p1}, Landroid/arch/lifecycle/LiveData$b;-><init>(Landroid/arch/lifecycle/LiveData;La/a/b/l;)V
...
.method public postValue(Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, v0}, La/a/a/b/a;->postToMainThread(Ljava/lang/Runnable;)V
...
.method public removeObserver(La/a/b/l;)V
    .locals 1
    .param p1    # La/a/b/l;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    ...
    .line 3
    :cond_0
    invoke-virtual {p1}, Landroid/arch/lifecycle/LiveData$c;->b()V
...
.method public removeObservers(La/a/b/e;)V
    .locals 3
    .param p1    # La/a/b/e;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {v2, p1}, Landroid/arch/lifecycle/LiveData$c;->c(La/a/b/e;)Z
    ...
    invoke-virtual {p0, v1}, Landroid/arch/lifecycle/LiveData;->removeObserver(La/a/b/l;)V
