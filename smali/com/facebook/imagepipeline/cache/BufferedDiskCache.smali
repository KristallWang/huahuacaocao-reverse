...
.method private containsAsync(Lcom/facebook/cache/common/CacheKey;)Lc/m;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, v1}, Lc/m;->call(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;)Lc/m;
    ...
    .line 5
    invoke-static {v0}, Lc/m;->forError(Ljava/lang/Exception;)Lc/m;
...
.method private foundPinnedImage(Lcom/facebook/cache/common/CacheKey;Lcom/facebook/imagepipeline/image/EncodedImage;)Lc/m;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    invoke-static {p2}, Lc/m;->forResult(Ljava/lang/Object;)Lc/m;
...
.method private getAsync(Lcom/facebook/cache/common/CacheKey;Ljava/util/concurrent/atomic/AtomicBoolean;)Lc/m;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, p2}, Lc/m;->call(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;)Lc/m;
    ...
    .line 5
    invoke-static {p2}, Lc/m;->forError(Ljava/lang/Exception;)Lc/m;
...
.method public contains(Lcom/facebook/cache/common/CacheKey;)Lc/m;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    :cond_0
    invoke-direct {p0, p1}, Lcom/facebook/imagepipeline/cache/BufferedDiskCache;->containsAsync(Lcom/facebook/cache/common/CacheKey;)Lc/m;
...
.method public get(Lcom/facebook/cache/common/CacheKey;Ljava/util/concurrent/atomic/AtomicBoolean;)Lc/m;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    invoke-direct {p0, p1, v0}, Lcom/facebook/imagepipeline/cache/BufferedDiskCache;->foundPinnedImage(Lcom/facebook/cache/common/CacheKey;Lcom/facebook/imagepipeline/image/EncodedImage;)Lc/m;
    ...
    :cond_2
    :try_start_1
    invoke-direct {p0, p1, p2}, Lcom/facebook/imagepipeline/cache/BufferedDiskCache;->getAsync(Lcom/facebook/cache/common/CacheKey;Ljava/util/concurrent/atomic/AtomicBoolean;)Lc/m;
...
.method public remove(Lcom/facebook/cache/common/CacheKey;)Lc/m;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
