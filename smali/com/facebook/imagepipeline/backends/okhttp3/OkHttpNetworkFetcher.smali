...
# instance fields
.field private final mCacheControl:Lj/d;
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
.end field

.field private final mCallFactory:Lj/e$a;

.field private mCancellationExecutor:Ljava/util/concurrent/Executor;


# direct methods
.method public constructor <init>(Lj/e$a;Ljava/util/concurrent/Executor;)V
    .locals 1

    const/4 v0, 0x1

    .line 2
    invoke-direct {p0, p1, p2, v0}, Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher;-><init>(Lj/e$a;Ljava/util/concurrent/Executor;Z)V

    return-void
.end method

.method public constructor <init>(Lj/e$a;Ljava/util/concurrent/Executor;Z)V
    .locals 0
    ...
    .line 4
    iput-object p1, p0, Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher;->mCallFactory:Lj/e$a;
    ...
    .line 6
    new-instance p1, Lj/d$a;

    invoke-direct {p1}, Lj/d$a;-><init>()V

    invoke-virtual {p1}, Lj/d$a;->noStore()Lj/d$a;

    move-result-object p1

    invoke-virtual {p1}, Lj/d$a;->build()Lj/d;
    ...
    :goto_0
    iput-object p1, p0, Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher;->mCacheControl:Lj/d;
...
.method public constructor <init>(Lj/z;)V
    ...
    invoke-virtual {v0}, Lj/p;->executorService()Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    invoke-direct {p0, p1, v0}, Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher;-><init>(Lj/e$a;Ljava/util/concurrent/Executor;)V
...
.method public static synthetic access$100(Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher;Lj/e;Ljava/lang/Exception;Lcom/facebook/imagepipeline/producers/NetworkFetcher$Callback;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3}, Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher;->handleException(Lj/e;Ljava/lang/Exception;Lcom/facebook/imagepipeline/producers/NetworkFetcher$Callback;)V

    return-void
.end method

.method private handleException(Lj/e;Ljava/lang/Exception;Lcom/facebook/imagepipeline/producers/NetworkFetcher$Callback;)V
    .locals 0

    .line 1
    invoke-interface {p1}, Lj/e;->isCanceled()Z
...
.method public fetch(Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher$OkHttpNetworkFetchState;Lcom/facebook/imagepipeline/producers/NetworkFetcher$Callback;)V
    ...
    .line 7
    iget-object v1, p0, Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher;->mCacheControl:Lj/d;

    if-eqz v1, :cond_0

    .line 8
    invoke-virtual {v0, v1}, Lj/b0$a;->cacheControl(Lj/d;)Lj/b0$a;
    ...
    invoke-virtual {v0, v2, v1}, Lj/b0$a;->addHeader(Ljava/lang/String;Ljava/lang/String;)Lj/b0$a;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher;->fetchWithRequest(Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher$OkHttpNetworkFetchState;Lcom/facebook/imagepipeline/producers/NetworkFetcher$Callback;Lj/b0;)V
    :try_end_0
...
.method public fetchWithRequest(Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher$OkHttpNetworkFetchState;Lcom/facebook/imagepipeline/producers/NetworkFetcher$Callback;Lj/b0;)V
    .locals 2

    .line 1
    iget-object v0, p0, Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher;->mCallFactory:Lj/e$a;

    invoke-interface {v0, p3}, Lj/e$a;->newCall(Lj/b0;)Lj/e;
    ...
    invoke-direct {v1, p0, p3}, Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher$1;-><init>(Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher;Lj/e;)V
    ...
    invoke-interface {p3, v0}, Lj/e;->enqueue(Lj/f;)V
