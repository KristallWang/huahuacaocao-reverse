.class public final Le/c/b/m/z;
.super Ljava/lang/Object;
.source "SourceFile"


# static fields
.field private static e:Le/c/b/m/z;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Le/c/b/m/z;->a:Landroid/support/v4/util/SimpleArrayMap;

    const/4 v0, 0x0

    .line 3
    iput-object v0, p0, Le/c/b/m/z;->b:Ljava/lang/Boolean;
    ...
    iput-object v0, p0, Le/c/b/m/z;->c:Ljava/util/Queue;
    ...
    iput-object v0, p0, Le/c/b/m/z;->d:Ljava/util/Queue;
...
.method private final b(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    .line 1
    iget-object v0, p0, Le/c/b/m/z;->a:Landroid/support/v4/util/SimpleArrayMap;

    monitor-enter v0

    .line 2
    :try_start_0
    iget-object v1, p0, Le/c/b/m/z;->a:Landroid/support/v4/util/SimpleArrayMap;
    ...
    .line 8
    :goto_0
    iget-object v2, p0, Le/c/b/m/z;->a:Landroid/support/v4/util/SimpleArrayMap;

    monitor-enter v2

    .line 9
    :try_start_1
    iget-object v3, p0, Le/c/b/m/z;->a:Landroid/support/v4/util/SimpleArrayMap;
    ...
    :goto_5
    :try_start_2
    iget-object v1, p0, Le/c/b/m/z;->b:Ljava/lang/Boolean;
    ...
    .line 18
    :cond_a
    iget-object v0, p0, Le/c/b/m/z;->b:Ljava/lang/Boolean;
...
.method public static zza(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    .line 1
    invoke-static {p0, p3, p2}, Le/c/b/m/z;->a(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)Landroid/content/Intent;
...
.method public static declared-synchronized zzai()Le/c/b/m/z;
    .locals 2

    const-class v0, Le/c/b/m/z;

    monitor-enter v0

    .line 1
    :try_start_0
    sget-object v1, Le/c/b/m/z;->e:Le/c/b/m/z;

    if-nez v1, :cond_0

    .line 2
    new-instance v1, Le/c/b/m/z;

    invoke-direct {v1}, Le/c/b/m/z;-><init>()V

    sput-object v1, Le/c/b/m/z;->e:Le/c/b/m/z;
...
.method public static zzb(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 1
    invoke-static {p0, v0, p1}, Le/c/b/m/z;->a(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)Landroid/content/Intent;
...
.method public final zzaj()Landroid/content/Intent;
    ...
    .line 1
    iget-object v0, p0, Le/c/b/m/z;->d:Ljava/util/Queue;
...
.method public final zzb(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
    ...
    .line 7
    :cond_4
    iget-object v0, p0, Le/c/b/m/z;->c:Ljava/util/Queue;
    ...
    .line 10
    invoke-direct {p0, p1, p3}, Le/c/b/m/z;->b(Landroid/content/Context;Landroid/content/Intent;)I
