...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, Lg/i1/i1;-><init>()V

    return-void
.end method

.method private static final c(ILg/r1/b/l;)Ljava/util/Set;
    .locals 1
    .param p1    # Lg/r1/b/l;
    ...
    .line 1
    invoke-static {p0}, Lg/i1/i1;->createSetBuilder(I)Ljava/util/Set;

    move-result-object p0

    invoke-interface {p1, p0}, Lg/r1/b/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {p0}, Lg/i1/i1;->build(Ljava/util/Set;)Ljava/util/Set;
...
.method private static final d(Lg/r1/b/l;)Ljava/util/Set;
    .locals 1
    .param p0    # Lg/r1/b/l;
        .annotation build Lkotlin/BuilderInference;
        .end annotation
    ...
    .line 1
    invoke-static {}, Lg/i1/i1;->createSetBuilder()Ljava/util/Set;

    move-result-object v0

    invoke-interface {p0, v0}, Lg/r1/b/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {v0}, Lg/i1/i1;->build(Ljava/util/Set;)Ljava/util/Set;
...
.method private static final e()Ljava/util/HashSet;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method private static final f()Ljava/util/LinkedHashSet;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method private static final g()Ljava/util/Set;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method private static final h(Ljava/util/Set;)Ljava/util/Set;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 1
    invoke-static {}, Lg/i1/j1;->emptySet()Ljava/util/Set;
...
.method public static final varargs hashSetOf([Ljava/lang/Object;)Ljava/util/HashSet;
    ...
    invoke-static {p0, v0}, Lg/i1/p;->toCollection([Ljava/lang/Object;Ljava/util/Collection;)Ljava/util/Collection;
...
.method public static final optimizeReadOnlySet(Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-static {p0}, Lg/i1/i1;->setOf(Ljava/lang/Object;)Ljava/util/Set;
...
.method public static final varargs setOf([Ljava/lang/Object;)Ljava/util/Set;
    ...
    invoke-static {p0}, Lg/i1/p;->toSet([Ljava/lang/Object;)Ljava/util/Set;
...
.method public static final varargs setOfNotNull([Ljava/lang/Object;)Ljava/util/Set;
    ...
    invoke-static {p0, v0}, Lg/i1/p;->filterNotNullTo([Ljava/lang/Object;Ljava/util/Collection;)Ljava/util/Collection;
