...
.method public static synthetic copyTo$default(Ljava/io/Reader;Ljava/io/Writer;IILjava/lang/Object;)J
    ...
    .line 1
    :cond_0
    invoke-static {p0, p1, p2}, Lg/p1/r;->copyTo(Ljava/io/Reader;Ljava/io/Writer;I)J
...
.method private static final e(Ljava/net/URL;Ljava/nio/charset/Charset;)Ljava/lang/String;
    .locals 1
    .annotation build Lkotlin/internal/InlineOnly;
    .end annotation
    ...
    .line 1
    invoke-static {p0}, Lg/p1/r;->readBytes(Ljava/net/URL;)[B
...
.method public static synthetic f(Ljava/net/URL;Ljava/nio/charset/Charset;ILjava/lang/Object;)Ljava/lang/String;
    .locals 0
...
.method public static final forEachLine(Ljava/io/Reader;Lg/r1/b/l;)V
    .locals 3
    .param p0    # Ljava/io/Reader;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    :try_start_0
    invoke-static {p0}, Lg/p1/r;->lineSequence(Ljava/io/BufferedReader;)Lg/x1/m;
...
.method private static final g(Ljava/lang/String;)Ljava/io/StringReader;
    .locals 1
    .annotation build Lkotlin/internal/InlineOnly;
    .end annotation
...
.method public static final lineSequence(Ljava/io/BufferedReader;)Lg/x1/m;
    .locals 1
    ...
    .line 1
    new-instance v0, Lg/p1/o;

    invoke-direct {v0, p0}, Lg/p1/o;-><init>(Ljava/io/BufferedReader;)V

    invoke-static {v0}, Lg/x1/s;->constrainOnce(Lg/x1/m;)Lg/x1/m;
...
.method public static final readBytes(Ljava/net/URL;)[B
    ...
    invoke-static {p0}, Lg/p1/a;->readBytes(Ljava/io/InputStream;)[B
    ...
    invoke-static {p0, v1}, Lg/p1/b;->closeFinally(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method public static final readLines(Ljava/io/Reader;)Ljava/util/List;
    ...
    .line 2
    new-instance v1, Lg/p1/r$a;

    invoke-direct {v1, v0}, Lg/p1/r$a;-><init>(Ljava/util/ArrayList;)V

    invoke-static {p0, v1}, Lg/p1/r;->forEachLine(Ljava/io/Reader;Lg/r1/b/l;)V
...
.method public static final readText(Ljava/io/Reader;)Ljava/lang/String;
    ...
    .line 2
    invoke-static {p0, v0, v1, v2, v3}, Lg/p1/r;->copyTo$default(Ljava/io/Reader;Ljava/io/Writer;IILjava/lang/Object;)J
...
.method public static final useLines(Ljava/io/Reader;Lg/r1/b/l;)Ljava/lang/Object;
    .locals 3
    .param p0    # Ljava/io/Reader;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
