.class public Lcom/miot/service/manager/scene/RunSceneTask;
...
.method public constructor <init>(Lcom/miot/common/people/People;ILcom/miot/api/ICompletionHandler;)V
    ...
    .line 2
    iput p2, p0, Lcom/miot/service/manager/scene/RunSceneTask;->mSceneId:I

    .line 3
    iput-object p3, p0, Lcom/miot/service/manager/scene/RunSceneTask;->mHandler:Lcom/miot/api/ICompletionHandler;
...
.method public bridge synthetic deliveryResult(Lcom/miot/service/common/task/MiotError;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/miot/service/manager/scene/RunSceneTask;->deliveryResult(Lcom/miot/service/common/task/MiotError;Ljava/lang/Void;)V
...
.method public deliveryResult(Lcom/miot/service/common/task/MiotError;Ljava/lang/Void;)V
    ...
    .line 3
    iget-object p1, p0, Lcom/miot/service/manager/scene/RunSceneTask;->mHandler:Lcom/miot/api/ICompletionHandler;
    ...
    .line 4
    :cond_0
    iget-object p2, p0, Lcom/miot/service/manager/scene/RunSceneTask;->mHandler:Lcom/miot/api/ICompletionHandler;
...
.method public executeRequest()Lcom/miot/service/common/miotcloud/HttpResponse;
    ...
    .line 2
    iget v2, p0, Lcom/miot/service/manager/scene/RunSceneTask;->mSceneId:I
    ...
    invoke-static {v1, v0}, Lcom/miot/service/common/miotcloud/MiotCloudApi;->runScene(Lcom/miot/common/people/People;Lorg/json/JSONObject;)Lcom/miot/service/common/miotcloud/HttpResponse;
...
.method public bridge synthetic parseResult(Lcom/miot/service/common/miotcloud/JsonResponse;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/miot/service/manager/scene/RunSceneTask;->parseResult(Lcom/miot/service/common/miotcloud/JsonResponse;)Ljava/lang/Void;
