.class public Lcom/miot/service/manager/scene/QueryScenesTask;
...
# instance fields
.field private mHandler:Lcom/miot/api/IScenesHandler;


# direct methods
.method public constructor <init>(Lcom/miot/common/people/People;Lcom/miot/api/IScenesHandler;)V
    .locals 0
    ...
    .line 2
    iput-object p2, p0, Lcom/miot/service/manager/scene/QueryScenesTask;->mHandler:Lcom/miot/api/IScenesHandler;
...
.method public bridge synthetic deliveryResult(Lcom/miot/service/common/task/MiotError;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/miot/service/manager/scene/QueryScenesTask;->deliveryResult(Lcom/miot/service/common/task/MiotError;Ljava/util/List;)V
...
.method public deliveryResult(Lcom/miot/service/common/task/MiotError;Ljava/util/List;)V
    ...
    .line 3
    iget-object p1, p0, Lcom/miot/service/manager/scene/QueryScenesTask;->mHandler:Lcom/miot/api/IScenesHandler;

    invoke-interface {p1, p2}, Lcom/miot/api/IScenesHandler;->onSucceed(Ljava/util/List;)V

    goto :goto_0

    .line 4
    :cond_0
    iget-object p2, p0, Lcom/miot/service/manager/scene/QueryScenesTask;->mHandler:Lcom/miot/api/IScenesHandler;
    ...
    invoke-interface {p2, v0, p1}, Lcom/miot/api/IScenesHandler;->onFailed(ILjava/lang/String;)V
    :try_end_0
...
.method public executeRequest()Lcom/miot/service/common/miotcloud/HttpResponse;
    ...
    invoke-static {v1, v0}, Lcom/miot/service/common/miotcloud/MiotCloudApi;->querySceneList(Lcom/miot/common/people/People;Lorg/json/JSONObject;)Lcom/miot/service/common/miotcloud/HttpResponse;
...
.method public bridge synthetic parseResult(Lcom/miot/service/common/miotcloud/JsonResponse;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/miot/service/manager/scene/QueryScenesTask;->parseResult(Lcom/miot/service/common/miotcloud/JsonResponse;)Ljava/util/List;
...
.method public parseResult(Lcom/miot/service/common/miotcloud/JsonResponse;)Ljava/util/List;
    ...
    .line 8
    invoke-static {v2}, Lcom/miot/common/scene/SceneBean;->create(Lorg/json/JSONObject;)Lcom/miot/common/scene/SceneBean;
