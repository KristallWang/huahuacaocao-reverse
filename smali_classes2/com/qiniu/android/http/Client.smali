...
.method public constructor <init>(Lcom/qiniu/android/http/ProxyConfiguration;IILcom/qiniu/android/http/UrlConverter;Lcom/qiniu/android/http/Dns;)V
    ...
    .line 4
    new-instance p4, Lj/z$b;

    invoke-direct {p4}, Lj/z$b;-><init>()V
    ...
    invoke-virtual {p4, v0}, Lj/z$b;->proxy(Ljava/net/Proxy;)Lj/z$b;
    ...
    .line 7
    invoke-virtual {p1}, Lcom/qiniu/android/http/ProxyConfiguration;->authenticator()Lj/b;

    move-result-object p1

    invoke-virtual {p4, p1}, Lj/z$b;->proxyAuthenticator(Lj/b;)Lj/z$b;
    ...
    invoke-virtual {p4, p1}, Lj/z$b;->dns(Lj/q;)Lj/z$b;

    .line 9
    :cond_1
    invoke-virtual {p4}, Lj/z$b;->networkInterceptors()Ljava/util/List;
    ...
    invoke-virtual {p4, p1, p2, p5}, Lj/z$b;->connectTimeout(JLjava/util/concurrent/TimeUnit;)Lj/z$b;

    int-to-long p1, p3

    .line 11
    invoke-virtual {p4, p1, p2, p5}, Lj/z$b;->readTimeout(JLjava/util/concurrent/TimeUnit;)Lj/z$b;

    const-wide/16 p1, 0x0

    .line 12
    invoke-virtual {p4, p1, p2, p5}, Lj/z$b;->writeTimeout(JLjava/util/concurrent/TimeUnit;)Lj/z$b;

    .line 13
    invoke-virtual {p4}, Lj/z$b;->build()Lj/z;

    move-result-object p1

    iput-object p1, p0, Lcom/qiniu/android/http/Client;->httpClient:Lj/z;

    return-void
.end method

.method public static synthetic access$100(Lj/d0;Ljava/lang/String;JLcom/qiniu/android/storage/UpToken;JLcom/qiniu/android/http/CompletionHandler;)V
    .locals 0

    .line 1
    invoke-static/range {p0 .. p7}, Lcom/qiniu/android/http/Client;->onRet(Lj/d0;Ljava/lang/String;JLcom/qiniu/android/storage/UpToken;JLcom/qiniu/android/http/CompletionHandler;)V

    return-void
.end method

.method private asyncMultipartPost(Ljava/lang/String;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;JLcom/qiniu/android/http/ProgressHandler;Ljava/lang/String;Lj/c0;Lcom/qiniu/android/http/CompletionHandler;Lcom/qiniu/android/http/CancellationHandler;)V
    .locals 14
    ...
    .line 10
    invoke-virtual {v1, v2, v3, v4}, Lcom/qiniu/android/http/MultipartBody$Builder;->addFormDataPart(Ljava/lang/String;Ljava/lang/String;Lj/c0;)Lcom/qiniu/android/http/MultipartBody$Builder;
    ...
    .line 12
    invoke-static {v2}, Lj/x;->parse(Ljava/lang/String;)Lj/x;

    move-result-object v2

    invoke-virtual {v1, v2}, Lcom/qiniu/android/http/MultipartBody$Builder;->setType(Lj/x;)Lcom/qiniu/android/http/MultipartBody$Builder;
    ...
    invoke-direct/range {v8 .. v13}, Lcom/qiniu/android/http/CountingRequestBody;-><init>(Lj/c0;Lcom/qiniu/android/http/ProgressHandler;JLcom/qiniu/android/http/CancellationHandler;)V
    ...
    invoke-virtual {v1, v0}, Lj/b0$a;->url(Ljava/lang/String;)Lj/b0$a;

    move-result-object v0

    invoke-virtual {v0, v9}, Lj/b0$a;->post(Lj/c0;)Lj/b0$a;
    ...
    .line 16
    invoke-virtual/range {v0 .. v6}, Lcom/qiniu/android/http/Client;->asyncSend(Lj/b0$a;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;JLcom/qiniu/android/http/CompletionHandler;)V
...
.method private static buildResponseInfo(Lj/d0;Ljava/lang/String;JLcom/qiniu/android/storage/UpToken;J)Lcom/qiniu/android/http/ResponseInfo;
    .locals 19

    move-object/from16 v1, p0

    .line 1
    invoke-virtual/range {p0 .. p0}, Lj/d0;->code()I
    ...
    .line 2
    invoke-virtual {v1, v0}, Lj/d0;->header(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    :try_start_0
    invoke-virtual/range {p0 .. p0}, Lj/d0;->body()Lj/e0;

    move-result-object v0

    invoke-virtual {v0}, Lj/e0;->bytes()[B
    ...
    .line 6
    :goto_1
    invoke-static/range {p0 .. p0}, Lcom/qiniu/android/http/Client;->ctype(Lj/d0;)Ljava/lang/String;
    ...
    .line 14
    :goto_4
    invoke-virtual/range {p0 .. p0}, Lj/d0;->request()Lj/b0;
    ...
    .line 15
    invoke-virtual {v1, v5}, Lj/d0;->header(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    .line 16
    invoke-static/range {p0 .. p0}, Lcom/qiniu/android/http/Client;->via(Lj/d0;)Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lj/v;->encodedPath()Ljava/lang/String;
    ...
    .line 17
    invoke-static/range {p0 .. p0}, Lcom/qiniu/android/http/Client;->getContentLength(Lj/d0;)J
...
.method private static ctype(Lj/d0;)Ljava/lang/String;
    .locals 2
    ...
    invoke-virtual {p0}, Lj/e0;->contentType()Lj/x;
    ...
    invoke-virtual {p0}, Lj/x;->type()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lj/x;->subtype()Ljava/lang/String;
...
.method private static getContentLength(Lj/d0;)J
    .locals 2
    ...
    invoke-virtual {p0}, Lj/b0;->body()Lj/c0;
    ...
    .line 2
    :cond_0
    invoke-virtual {p0}, Lj/c0;->contentLength()J
...
.method private static onRet(Lj/d0;Ljava/lang/String;JLcom/qiniu/android/storage/UpToken;JLcom/qiniu/android/http/CompletionHandler;)V
    .locals 0

    .line 1
    invoke-static/range {p0 .. p6}, Lcom/qiniu/android/http/Client;->buildResponseInfo(Lj/d0;Ljava/lang/String;JLcom/qiniu/android/storage/UpToken;J)Lcom/qiniu/android/http/ResponseInfo;
...
.method private send(Lj/b0$a;Lcom/qiniu/android/utils/StringMap;)Lcom/qiniu/android/http/ResponseInfo;
    .locals 21
    ...
    invoke-direct {v3, v1, v0}, Lcom/qiniu/android/http/Client$7;-><init>(Lcom/qiniu/android/http/Client;Lj/b0$a;)V
    ...
    invoke-virtual {v0, v3, v2}, Lj/b0$a;->header(Ljava/lang/String;Ljava/lang/String;)Lj/b0$a;
    ...
    .line 5
    invoke-virtual {v0, v2}, Lj/b0$a;->tag(Ljava/lang/Object;)Lj/b0$a;
    ...
    .line 6
    :try_start_0
    iget-object v0, v1, Lcom/qiniu/android/http/Client;->httpClient:Lj/z;

    invoke-virtual {v0, v3}, Lj/z;->newCall(Lj/b0;)Lj/e;
    ...
    invoke-static/range {v4 .. v10}, Lcom/qiniu/android/http/Client;->buildResponseInfo(Lj/d0;Ljava/lang/String;JLcom/qiniu/android/storage/UpToken;J)Lcom/qiniu/android/http/ResponseInfo;
    ...
    .line 9
    invoke-virtual {v3}, Lj/b0;->url()Lj/v;
    ...
    invoke-virtual {v6}, Lj/v;->encodedPath()Ljava/lang/String;
...
.method private syncMultipartPost(Ljava/lang/String;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;JLjava/lang/String;Lj/c0;)Lcom/qiniu/android/http/ResponseInfo;
    .locals 6
    ...
    .line 8
    invoke-virtual {v0, v1, p6, p7}, Lcom/qiniu/android/http/MultipartBody$Builder;->addFormDataPart(Ljava/lang/String;Ljava/lang/String;Lj/c0;)Lcom/qiniu/android/http/MultipartBody$Builder;
    ...
    invoke-virtual {v0, p2}, Lcom/qiniu/android/http/MultipartBody$Builder;->setType(Lj/x;)Lcom/qiniu/android/http/MultipartBody$Builder;
    ...
    .line 12
    new-instance p6, Lj/b0$a;

    invoke-direct {p6}, Lj/b0$a;-><init>()V

    invoke-virtual {p6, p1}, Lj/b0$a;->url(Ljava/lang/String;)Lj/b0$a;

    move-result-object p1

    invoke-virtual {p1, p2}, Lj/b0$a;->post(Lj/c0;)Lj/b0$a;
    ...
    .line 13
    invoke-virtual/range {v0 .. v5}, Lcom/qiniu/android/http/Client;->syncSend(Lj/b0$a;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;J)Lcom/qiniu/android/http/ResponseInfo;
...
.method private static via(Lj/d0;)Ljava/lang/String;
    .locals 3
    ...
    .line 1
    invoke-virtual {p0, v0, v1}, Lj/d0;->header(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public asyncGet(Ljava/lang/String;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;Lcom/qiniu/android/http/CompletionHandler;)V
    ...
    invoke-virtual {v0}, Lj/b0$a;->get()Lj/b0$a;

    move-result-object v0

    invoke-virtual {v0, p1}, Lj/b0$a;->url(Ljava/lang/String;)Lj/b0$a;
    ...
    .line 2
    invoke-virtual/range {v1 .. v7}, Lcom/qiniu/android/http/Client;->asyncSend(Lj/b0$a;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;JLcom/qiniu/android/http/CompletionHandler;)V
...
.method public asyncMultipartPost(Ljava/lang/String;Lcom/qiniu/android/http/PostArgs;Lcom/qiniu/android/storage/UpToken;Lcom/qiniu/android/http/ProgressHandler;Lcom/qiniu/android/http/CompletionHandler;Lcom/qiniu/android/http/CancellationHandler;)V
    ...
    invoke-static {v1}, Lj/x;->parse(Ljava/lang/String;)Lj/x;

    move-result-object v1

    iget-object v2, v0, Lcom/qiniu/android/http/PostArgs;->file:Ljava/io/File;

    invoke-static {v1, v2}, Lj/c0;->create(Lj/x;Ljava/io/File;)Lj/c0;
    ...
    invoke-direct/range {v4 .. v14}, Lcom/qiniu/android/http/Client;->asyncMultipartPost(Ljava/lang/String;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;JLcom/qiniu/android/http/ProgressHandler;Ljava/lang/String;Lj/c0;Lcom/qiniu/android/http/CompletionHandler;Lcom/qiniu/android/http/CancellationHandler;)V
...
.method public asyncPost(Ljava/lang/String;[BIILcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;JLcom/qiniu/android/http/ProgressHandler;Lcom/qiniu/android/http/CompletionHandler;Lcom/qiniu/android/http/CancellationHandler;)V
    ...
    .line 5
    invoke-static {v3}, Lj/x;->parse(Ljava/lang/String;)Lj/x;
    ...
    .line 8
    invoke-static {v3, v0, v4, v5}, Lj/c0;->create(Lj/x;[BII)Lj/c0;
    ...
    .line 9
    invoke-static {v0, v3}, Lj/c0;->create(Lj/x;[B)Lj/c0;
...
.method public asyncSend(Lj/b0$a;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;JLcom/qiniu/android/http/CompletionHandler;)V
    .locals 8
    ...
    invoke-direct {v0, p0, p1}, Lcom/qiniu/android/http/Client$4;-><init>(Lcom/qiniu/android/http/Client;Lj/b0$a;)V
    ...
    .line 5
    iget-object p2, p0, Lcom/qiniu/android/http/Client;->httpClient:Lj/z;

    invoke-virtual {p1, v3}, Lj/b0$a;->tag(Ljava/lang/Object;)Lj/b0$a;
    ...
    invoke-interface {p1, p2}, Lj/e;->enqueue(Lj/f;)V
...
.method public syncGet(Ljava/lang/String;Lcom/qiniu/android/utils/StringMap;)Lcom/qiniu/android/http/ResponseInfo;
    ...
    .line 2
    invoke-direct {p0, p1, p2}, Lcom/qiniu/android/http/Client;->send(Lj/b0$a;Lcom/qiniu/android/utils/StringMap;)Lcom/qiniu/android/http/ResponseInfo;
...
.method public syncMultipartPost(Ljava/lang/String;Lcom/qiniu/android/http/PostArgs;Lcom/qiniu/android/storage/UpToken;)Lcom/qiniu/android/http/ResponseInfo;
    ...
    invoke-static {v0, v1}, Lj/c0;->create(Lj/x;Ljava/io/File;)Lj/c0;
    ...
    invoke-static {v0, v1}, Lj/c0;->create(Lj/x;[B)Lj/c0;
    ...
    invoke-direct/range {v3 .. v10}, Lcom/qiniu/android/http/Client;->syncMultipartPost(Ljava/lang/String;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;JLjava/lang/String;Lj/c0;)Lcom/qiniu/android/http/ResponseInfo;
...
.method public syncSend(Lj/b0$a;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;J)Lcom/qiniu/android/http/ResponseInfo;
    .locals 20
    ...
    invoke-direct {v3, v1, v0}, Lcom/qiniu/android/http/Client$9;-><init>(Lcom/qiniu/android/http/Client;Lj/b0$a;)V
    ...
    invoke-virtual {v0, v11}, Lj/z;->newCall(Lj/b0;)Lj/e;
    ...
    invoke-static/range {v3 .. v9}, Lcom/qiniu/android/http/Client;->buildResponseInfo(Lj/d0;Ljava/lang/String;JLcom/qiniu/android/storage/UpToken;J)Lcom/qiniu/android/http/ResponseInfo;
    ...
    invoke-virtual {v2}, Lj/v;->encodedPath()Ljava/lang/String;

    move-result-object v9

    .line 15
    invoke-virtual {v2}, Lj/v;->port()I
