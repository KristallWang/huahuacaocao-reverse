...
.field private e:Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a$a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->e:Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a$a;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->f:Ljava/util/ArrayList;
...
.method public static synthetic a(Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;)Landroid/content/Context;
    ...
    iget-object p0, p0, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->b:Landroid/content/Context;
...
.method private b(Lcom/xiaomi/xmpush/thrift/f;)V
    .locals 2

    iget-object v0, p0, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->f:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->f:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->f:Ljava/util/ArrayList;
...
.method private c(Landroid/content/Context;)Z
    ...
    invoke-virtual {p1}, Lcom/xiaomi/mipush/sdk/d;->c()Ljava/lang/String;

    move-result-object p1

    if-nez p1, :cond_0

    iget-object p1, p0, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->b:Landroid/content/Context;

    invoke-direct {p0, p1}, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->b(Landroid/content/Context;)Z
...
.method private c(Lcom/xiaomi/xmpush/thrift/f;)Z
    .locals 2

    const/4 v0, 0x0

    invoke-static {p1, v0}, Lcom/xiaomi/push/service/bj;->a(Lcom/xiaomi/xmpush/thrift/f;Z)Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->d:Ljava/lang/Boolean;
    ...
    iget-object v0, p0, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->b:Landroid/content/Context;

    invoke-static {v0}, Lcom/xiaomi/mipush/sdk/az;->a(Landroid/content/Context;)Lcom/xiaomi/mipush/sdk/az;

    move-result-object v0

    invoke-virtual {v0, p1}, Lcom/xiaomi/mipush/sdk/az;->a(Lcom/xiaomi/xmpush/thrift/f;)V

    goto :goto_0

    :cond_1
    iget-object v0, p0, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->e:Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a$a;

    invoke-virtual {v0, p1}, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a$a;->a(Lcom/xiaomi/xmpush/thrift/f;)V
...
.method public a(Landroid/content/Context;)V
    ...
    :cond_0
    iput-object p1, p0, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->b:Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->d:Ljava/lang/Boolean;
...
.method public declared-synchronized a(Ljava/lang/String;)V
    ...
    :cond_0
    :try_start_1
    iput-object p1, p0, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->c:Ljava/lang/String;
...
.method public declared-synchronized a(Lcom/xiaomi/xmpush/thrift/f;)Z
    .locals 5
    ...
    iget-object v2, p0, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->c:Ljava/lang/String;
    ...
    :goto_0
    invoke-virtual {p0}, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->b()Z
    ...
    :goto_1
    iget-object v4, p0, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->b:Landroid/content/Context;

    if-eqz v4, :cond_4

    invoke-direct {p0, v4}, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->c(Landroid/content/Context;)Z
    ...
    iget-object v0, p0, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->c:Ljava/lang/String;
    ...
    :cond_a
    invoke-direct {p0, p1}, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->c(Lcom/xiaomi/xmpush/thrift/f;)Z
    ...
    :cond_e
    :goto_4
    invoke-direct {p0, p1}, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->b(Lcom/xiaomi/xmpush/thrift/f;)V
    :try_end_2
...
.method public b(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lcom/xiaomi/mipush/sdk/MiTinyDataClient$a;->a(Lcom/xiaomi/xmpush/thrift/f;)Z
